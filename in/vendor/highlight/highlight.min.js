...
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);/*! `groovy` grammar compiled for Highlight.js 11.4.0 */
...
illegal:/#|<\//}}})();hljs.registerLanguage("groovy",e)})();/*! `css` grammar compiled for Highlight.js 11.4.0 */
(()=>{var e=(()=>{"use strict"
...
;hljs.registerLanguage("dockerfile",e)})();/*! `lisp` grammar compiled for Highlight.js 11.4.0 */
...
})();hljs.registerLanguage("xml",e)})();/*! `plaintext` grammar compiled for Highlight.js 11.4.0 */
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})()
;hljs.registerLanguage("sql",e)})();/*! `ruby` grammar compiled for Highlight.js 11.4.0 */
(()=>{var e=(()=>{"use strict";return e=>{
...
aliases:["yml"],contains:b}}})();hljs.registerLanguage("yaml",e)})();/*! `r` grammar compiled for Highlight.js 11.4.0 */
(()=>{var e=(()=>{"use strict";return e=>{
...
contains:[{begin:/\\./}]}]}}})();hljs.registerLanguage("r",e)})();/*! `javascript` grammar compiled for Highlight.js 11.4.0 */
(()=>{var e=(()=>{"use strict"
...
;hljs.registerLanguage("rust",e)})();/*! `ebnf` grammar compiled for Highlight.js 11.4.0 */
...
;hljs.registerLanguage("ebnf",e)})();/*! `glsl` grammar compiled for Highlight.js 11.4.0 */
...
className:"meta",begin:"#",end:"$"}]})})();hljs.registerLanguage("glsl",e)})();/*! `go` grammar compiled for Highlight.js 11.4.0 */
(()=>{var e=(()=>{"use strict";return e=>{const n={
...
;hljs.registerLanguage("go",e)})();/*! `c` grammar compiled for Highlight.js 11.4.0 */
...
;hljs.registerLanguage("markdown",e)})();/*! `diff` grammar compiled for Highlight.js 11.4.0 */
